...
# Crispy clean GIF
ffmpeg -hide_banner -loglevel error -framerate 10 -start_number 1 -i '%d.png' -vf "scale=54:-1:flags=lanczos,split[s0][s1];[s0]palettegen[p];[s1][p]paletteuse" -loop 0 -y ledscreen.gif
